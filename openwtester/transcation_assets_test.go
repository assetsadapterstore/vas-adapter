...
func TestTransfer(t *testing.T) {
	...
	addrs := []string{
		"VJzZnE5jLoUCoG58UR9PHx9ssKTQBAaRN7",
		"VCYj1BNhLxgxHQXsQr2UB1qoknckNvTWux",
		"VNDfogZBW9v7QnJxEDjEV4QYrqpihV5G8z",
	}
	...
	for _, to := range addrs {
		...
		rawTx, err := testCreateTransactionStep(tm, walletID, accountID, to, "0.12345678", "0.0001", nil)
		if err != nil {
			return
		}
...
func TestSummary(t *testing.T) {
	...
	summaryAddress := "VSaJg2ARstrpqh6GdwfMZF1xBY25xnPEBV"
