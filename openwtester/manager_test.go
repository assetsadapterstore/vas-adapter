...
func TestWalletManager_CreateWallet(t *testing.T) {
	...
	w := &openwallet.Wallet{Alias: "HELLO VAS", IsTrust: true, Password: "12345678"}
...
func TestWalletManager_GetWalletInfo(t *testing.T) {
	...
	wallet, err := tm.GetWalletInfo(testApp, "W7HUU4EKySBVPZvxoh5nWQipVH4aF3ew1E")
	if err != nil {
...
func TestWalletManager_CreateAssetsAccount(t *testing.T) {
	...
	walletID := "WAtfhbvP5Z8Bm5zBqXDSDLUpvEnFaT54vc"
	account := &openwallet.AssetsAccount{Alias: "testChargeVAS1", WalletID: walletID, Required: 1, Symbol: "VAS", IsTrust: true}
...
func TestWalletManager_CreateAddress(t *testing.T) {
	...
	walletID := "W7HUU4EKySBVPZvxoh5nWQipVH4aF3ew1E"
	accountID := "F3TMEb84ivJux8JA8ZtEmeb2c1ddktH68iDa2jnBupnE"
